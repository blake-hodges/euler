...
//input: multidimensional array that represents a square grid

//find products from grid[0][0] to three next adjacent elements to the right, down, and horizontally
//do this for each number in the grid
//save each group of four factors together as object value with corresponding product key
//compare the products to find the largest

//output: the largest product of any four adjacent numbers
...
function largestGridProduct(arr) {
    ...
    //find largest number from products array
    var max = productsArray.reduce(function(a, b) {
    return Math.max(a, b);
    });
